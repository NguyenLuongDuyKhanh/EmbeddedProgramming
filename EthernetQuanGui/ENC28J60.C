...
//unsigned char SPI0_ReadWrite(unsigned char writedat)
//{
//	   /* Loop while DR register in not emplty */
//   while (SPI_GetStatus(SPI0, SPI_TX_EMPTY_MASK) == 0);

//   /* Send byte through the SPI1 peripheral */
//   SPI_WRITE_TX(SPI0,(uint8_t)writedat);
//		SPI_TRIGGER(SPI0);
//   /* Wait to receive a byte */
//   while (SPI_GetStatus(SPI0, SPI_RX_EMPTY_MASK) == 0);
